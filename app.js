...
app.get("/login", function (req, res) {
  ...
  var scope = 'streaming user-modify-playback-state user-read-private user-read-email playlist-read playlist-read-private playlist-modify playlist-modify-private';
